...
public class Playground {
    ...
    /**
     * Constructeur de la classe Playground
     *
     * Ce constructeur charge les images nécessaires pour le terrain de jeu
     * et lit un fichier pour initialiser l'environnement avec différents types de sprite
     * @param pathName
     */
    ...
    /**
     * Récupère une liste des sprites solides présents dans l'environnement
     *
     * Cette méthode parcourt la liste des sprites de l'environnement et
     * retourne une nouvelle liste contenant uniquement les sprites qui
     * sont des instances de SolidSprite
     * @return
     */
    ...
    /**
     * Récupère une liste des sprites affichables présents dans l'environnement
     *
     * Cette méthode parcourt la liste des sprites de l'environnement et
     * retourne une nouvelle liste contenant tous les sprites qui peuvent
     * être affichés (c'est-à-dire, qui implémentent l'interface Displayable)
     * @return
     */
